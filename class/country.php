 ...
 *
 */
class AnalyticsCountry extends icms_ipf_Object {

	public function __construct(&$handler) {
		parent::__construct($handler);
		
		$this->quickInitVar('country_id', XOBJ_DTYPE_INT, true);
 ...
 *
 */
class AnalyticsCountryHandler extends icms_ipf_Handler {
	
	public function __construct(&$db) {
		parent::__construct($db, 'country', 'country_id', 'name', 'user_agent', 'analytics');
	}
